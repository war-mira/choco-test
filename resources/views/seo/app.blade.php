...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{route('seo.dashboard')}}">iDoctor - SEO</a>
        </div>
        <!-- /.navbar-header -->
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="{{route('seo.dashboard')}}"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-th-list fa-fw"></i> Контент<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="#"><i class="fa fa-database fa-fw"></i> Все</a>
                            </li>
                            <li>
                                <a href="#"><i class="fa fa-group fa-fw"></i> Врачи<span class="fa arrow"></span></a>
                                <ul class="nav nav-third-level">
                                    <li>
                                        <a href="{{route('seo.doctors.table.view')}}">Таблица</a>
                                    </li>
                                    <li>
                                        <a href="#">Статистика</a>
                                    </li>
                            ...
                            <li>
                                <a href="#"><i class="fa fa-hospital-o fa-fw"></i> Медцентры<span
                                            class="fa arrow"></span></a>
                                <ul class="nav nav-third-level">
                                    <li>
                                        <a href="{{route('seo.medcenters.table.view')}}">Таблица</a>
                                    </li>
                                    <li>
                                        <a href="#">Статистика</a>
                                    </li>
                            ...
                            <li>
                                <a href="#"><i class="fa fa-plus-square fa-fw"></i> Специализации<span
                                            class="fa arrow"></span></a>
                                <ul class="nav nav-third-level">
                                    <li>
                                        <a href="{{route('seo.skills.table.view')}}">Таблица</a>
                                    </li>
                                    <li>
                                        <a href="#">Статистика</a>
                                    </li>
                            ...
                            <li>
                                <a href="#"><i class="fa fa-file fa-fw"></i> PageSeo<span
                                            class="fa arrow"></span></a>
                                <ul class="nav nav-third-level">
                                    <li>
                                        <a href="{{route('seo.pageseo.table.view')}}">Таблица</a>
                                    </li>
                                </ul>
                                <!-- /.nav-second-level -->
                            </li>
