                ...
                <div class="entity-line__img">
                    <div class="entity-thumb-img">
                        <div class="entity-thumb-img__img-wr">
                            @component('components.medcenters-img',['class_min'=>$medcenter->checkImageheight()??'0'])
                                @slot('src')
                                    {{$medcenter['avatar']}}
                                @endslot
                                @slot('width')
                    ...
                    <div class="clinic-line__brief">
                        <div class="clinic-line__brief-line">
                            ...
                            <div class="clinic-line__brief-item">
                                ...
                                @if(!empty($medcenter->getWebsiteLink()))
                                    <div class="clinic-line__brief-name">
                                        Веб-сайт:
                                    </div>
                                    <div class="profiles__desc clinic-line__brief-descr">
                                        <a href="{{$medcenter->getWebsiteLink()}}" rel="nofollow noopenner"
                ...
                <div class="entity-line__additional">
                    ...
                    <div class="entity-line__map entity-map" id="entity-map">
                        <div class="entity-map__address">
                            <div class="entity-map__address-name">{{$medcenter->city->name}}
                                , {{$medcenter->sms_address}}</div>
                            @if($medcenter['map'])
                                <div class="entity-map__address-descr">({{$medcenter['map']}})</div>@endif
                        </div>
                    </div>
                    @php
                            ...
                            <div class="entity-profiles__list">
                                @foreach ($medcenter->skills() as $item)
                                    @if($loop->iteration%3 == 1 || $loop->first)
                                        <div class="entity-profiles__col"> @endif
                    ...
                    <div class="entity-about__content entity-content">
                        <div class="entity-content__main entity-content__main_single">
                            <div class="doc-list-bar">
                                <div class="doc-list-bar__line" id="medoc_filter"
                                    ...
                                    <div class="doc-list-bar__sort sort-line">
                                        ...
                                        <a href="#" data-name="rate"
                                           class="sort-line__item sort-line-btn btn btn_theme_radio btn_theme_radio_active">
                                            <span class="sort-line-btn__text">Рейтингу</span>
                                            <i class="fa fa-chevron-down" aria-hidden="true"></i>
                                        </a>
                                        <a href="#" data-name="works_since"
                                           class="sort-line__item sort-line-btn btn btn_theme_radio">
                                            <span class="sort-line-btn__text">Стажу</span>
                                            <i class="fa fa-chevron-down" aria-hidden="true"></i>
                                        </a>
                                        <a href="#" data-name="comments_count"
                                           class="sort-line__item sort-line-btn btn btn_theme_radio">
                                            <span class="sort-line-btn__text">Отзывам</span>
                                            <i class="fa fa-chevron-down" aria-hidden="true"></i>
                                        </a>
                                        <a href="#" data-name="price"
                                           class="sort-line__item sort-line-btn btn btn_theme_radio">
                                            <span class="sort-line-btn__text">Стоимости</span>
                                            <i class="fa fa-chevron-down" aria-hidden="true"></i>
                                        </a>
                                        <a href="#" data-name="orders_count"
                                           class="sort-line__item sort-line-btn btn btn_theme_radio">
                            ...
                            <div class="doc-list">
                                ...
                                <load-doctors-btn model="medcenter" id="{{ $medcenter->id }}" visible="{{ $visible }}"
                                                  quantity="{{$ost}}">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $('#medoc_filter a.sort-line__item').click(function (e) {
                ...
                var cat = $(this).is('.btn_theme_radio_active'), asdes = $('input[name="orderm"]').val(),
                    order = 'DESC';
