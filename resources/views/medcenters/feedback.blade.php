    ...
    <div class="feedback__doctor-container">
        <div class="feedback__doctor-description">
            <div class="doctor-photo">
                <img src="{{url($medcenter['avatar'])}}">
            </div>
            <div class="doctor-name">{{$medcenter['name']}}</div>
        </div>
        <div class="feedback__review-container">
            <form class="feedback__form" id="feedback__form">
                {{ csrf_field() }}
                <input type="hidden" id="owner_type" value="Medcenter">
                <input type="hidden" id="owner_id" value="{{$medcenter->id}}">
                <input type="hidden" id="type" value="{{ $type }}">
                <div class="feedback__rating">
                    <p>Оцените данную клинику</p>
                    <div class="rating">
                ...
                <div class="user-info">
                    ...
                    <div class="row with-padding">
                        <div class="form-group col-md-12">
                            <label>Ваш отзыв о медцентре</label>
                            <p class="tip small with-border-row">Поделитесь впечатлениями о посещении клиники. Будьте
