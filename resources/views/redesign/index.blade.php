            ...
            <div class="index-intro__container">
                ...
                <div class="index-intro__stats">
                    <div class="index-intro__stat-item">
                        <div class="index-intro__stat-img"><img src="img/icon-stat-1.svg" alt=""></div>
                    ...
                    <div class="index-intro__stat-item">
                        <div class="index-intro__stat-img"><img src="img/icon-stat-2.svg" alt=""></div>
                    ...
                    <div class="index-intro__stat-item">
                        <div class="index-intro__stat-img"><img src="img/icon-stat-3.svg" alt=""></div>
    ...
    <section class="section pattern-bg doc-letter-search">
        <div class="container">
            <div class="section-heading doc-letter-search__heading">
                ...
                <div class="section-heading__descr">Мы поможем найти проверенного врача и записаться на прием в удобное для Вас время</div>
            </div>
        ...
        <div class="container">
            ...
            <div class="work-flow__steps">
                <div class="work-flow__steps-item">
                    <div class="work-flow__steps-item-img">
                        <span>1</span>
                        <img src="img/work-flow-1.svg" alt="">
                    </div>
                ...
                <div class="work-flow__steps-item">
                    <div class="work-flow__steps-item-img">
                        <span>2</span>
                        <img src="img/work-flow-2.svg" alt="">
                    </div>
                    <div class="work-flow__steps-item-text">Записываетесь на прием <a href="#">онлайн</a> или по телефону</div>
                </div>
                <div class="work-flow__steps-item">
                    <div class="work-flow__steps-item-img">
                        <span>3</span>
                        <img src="img/work-flow-3.svg" alt="">
                    </div>
            ...
            <div class="video-block">
                <div class="video-block__videoframe">
                    <iframe src="https://www.youtube.com/embed/OkHU9CY7sjA" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="section blog-list">
        <div class="container">
            ...
            <div class="blog-list__list">
                ...
                <div class="blog-item blog-list__list-item toning" style="background-image: url({{ URL::asset($post['cover_image'])}});">
                    <div class="blog-item__name">{{$post['title']}}</div>
                    <div class="blog-item__bot-line">
                        <a href="{{url('post/'.$post['alias'])}}" class="blog-item__link"><span>Читать целиком</span><i class="fa fa-chevron-right" aria-hidden="true"></i></a>
    ...
    <section class="section partners">
        <div class="container">
            ...
            <div class="partners__list">
                <div class="partners__list-item"><img src="img/partner/1.jpg" alt=""></div>
                <div class="partners__list-item"><img src="img/partner/2.jpg" alt=""></div>
                <div class="partners__list-item"><img src="img/partner/3.jpg" alt=""></div>
                <div class="partners__list-item"><img src="img/partner/4.jpg" alt=""></div>
                <div class="partners__list-item"><img src="img/partner/5.jpg" alt=""></div>
                <div class="partners__list-item"><img src="img/partner/6.jpg" alt=""></div>
            </div>
        </div>
    </section>
@endsection