...
@section('columns')
    ...
    <th data-field="title" data-sortable="true">Заголовок</th>
    <th data-field="alias" data-sortable="true">Ссылка</th>
    <th data-field="content_lite" data-sortable="true">Контент</th>
