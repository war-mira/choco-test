<div class="entity-line__img">
    <div class="entity-thumb-img">
        <div class="entity-thumb-img__img-wr">
            <div class="parent_cont medcenters">
                <img src="/images/SAkUlyWu3m2cyQdIxIYYDUlZHNCIDLEakxOUXNVX.jpeg" alt="SVS Клиника имени Савинова В.М." class="entity-thumb-img__img profiles__img profiles__img--circle   " style="max-width: 250px; max-height: 200px;">
            </div>
        </div>
        <div class="entity-thumb-img__rating-line rating-line">
            <div class="rating-line__val">5</div>
...
<div class="entity-line__main">
    <div class="h3 profiles__title">
        <div class="entity-line__name">
            <a href="#">SVS Клиника имени Савинова В.М.</a>
        </div>
    </div>
